# Android Dockerfile
#
# Derived from uber/android-build-environment
# via fork @ angeliski/android-build-environment
...
# Install Android SDK
RUN cd /usr/local/ && wget https://dl.google.com/android/repository/tools_r25.2.3-linux.zip && \
